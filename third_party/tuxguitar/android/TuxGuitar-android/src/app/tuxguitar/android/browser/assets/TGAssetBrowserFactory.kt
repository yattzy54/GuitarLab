...
class TGAssetBrowserFactory(private val context: TGContext) : TGBrowserFactory {
    private val settings = TGAssetBrowserSettings(context)
    override fun getType(): String = BROWSER_TYPE
    override fun getName(): String = getDefaultSettings().getTitle()
    ...
    fun createDemoCollection(): TGBrowserCollection = TGBrowserManager.getInstance(context).createCollection(type, getDefaultSettings().toBrowserSettings())
