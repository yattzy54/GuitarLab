...
class TGMeasureCleanDialog : TGComposeDialog() {
    @Composable
...
fun TGMeasureCleanDialogContent(
    ...
    val viewModel = scopedEditorViewModel { TGMeasureCleanDialogViewModel(TGMeasureCleanDialogState(initialFrom, initialTo)) }
